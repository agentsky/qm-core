...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | ---------- |
| FF1 | Prod cache config: `PI_SYSTEM_CACHE_SPLIT=1` on the deployed core workload (staging-only today) + extended cache retention (1h) if the SDK knob confirms out                                                             | config-only                                                                            | phase 1    |
